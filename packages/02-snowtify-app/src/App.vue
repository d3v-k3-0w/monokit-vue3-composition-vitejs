...
<template>
	<div>
		<div
			...
			<button
				...
				<div class="flex items-center">
					<img
						src="https://img.freepik.com/vector-premium/hombre-masculino-auriculares-escuchando-musica-vista-lateral-silueta-logotipo-diseno-vector_198454-489.jpg"
						class="rounded-full"
						width="27"
						alt="user" />
					<div class="text-white text-[14px] ml-1.5 font-semibold">d3v_k3_0w</div>
					<ChevronDown
						v-if="!openMenu"
						@click="openMenu = true"
						fillColor="#FFFFFF"
		...
		<div id="SideNav" class="h-[100%] p-6 w-[240px] fixed z-50 bg-black">
			<RouterLink to="/">
				<img src="/images/icons/spotify-logo.png" width="125" alt="logo spotify" />
			</RouterLink>
			<div class="my-8"></div>
			<ul>
				<RouterLink to="/">
